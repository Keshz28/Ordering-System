...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ref={ref}
    className={cn(
      "inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors data-[state=checked]:bg-brand-700 data-[state=unchecked]:bg-cream-500 disabled:cursor-not-allowed disabled:opacity-50",
      className,
    )}
    {...props}
  >
