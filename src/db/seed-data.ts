...
export const MODIFIER_TEMPLATES = {
  pizzaSize: {
    ...
    maxSelection: 1,
    options: [
      { name: 'Small — 9"', priceDelta: -6 },
      { name: 'Regular — 12"', priceDelta: 0, isDefault: true },
      { name: 'Large — 16"', priceDelta: 12 },
    ],
  },
  pizzaToppings: {
    name: "Extra toppings",
    ...
    maxSelection: 5,
    options: [
      { name: "Extra fior di latte", priceDelta: 6 },
      { name: "Spicy nduja", priceDelta: 9 },
      { name: "Prosciutto di Parma", priceDelta: 10 },
      { name: "Taggiasca olives", priceDelta: 5 },
      { name: "Truffle oil drizzle", priceDelta: 9 },
      { name: "Fresh basil", priceDelta: 2 },
    ],
  },
  pastaAddon: {
    name: "Make it yours",
    ...
    maxSelection: 3,
    options: [
      { name: "Grilled chicken", priceDelta: 14 },
      { name: "Tiger prawns", priceDelta: 18 },
      { name: "Extra parmigiano", priceDelta: 5 },
      { name: "Gluten-free pasta", priceDelta: 6 },
    ],
  },
  doneness: {
...
export const REDEMPTIONS = [
  {
    name: "RM15 off your order",
    description: "A straight RM15 off, no minimum fuss.",
    pointsCost: 200,
...
export const CUSTOMERS: SeedCustomer[] = [
  { name: "Amelia Hart", email: "amelia.hart@example.com", phone: "+60 12-201 8834", birthday: "1991-08-19", allergies: ["nuts"], preferences: "Window table, still water", frequency: "heavy" },
  { name: "Daniel Okafor", email: "daniel.okafor@example.com", phone: "+60 13-244 1190", birthday: "1986-02-04", allergies: [], preferences: "Always orders the Diavola", frequency: "heavy" },
  { name: "Priyanka Shah", email: "priyanka.shah@example.com", phone: "+60 14-277 4521", birthday: "1994-11-27", allergies: ["shellfish"], preferences: "Vegetarian most visits", frequency: "heavy" },
  { name: "Marcus Lindberg", email: "marcus.lindberg@example.com", phone: "+60 16-290 7712", birthday: "1979-05-12", allergies: [], preferences: "Wine pairing, no rush", frequency: "regular" },
  { name: "Chloé Dubois", email: "chloe.dubois@example.com", phone: "+60 17-311 2098", birthday: "1997-08-16", allergies: ["dairy"], preferences: "Asks for dairy-free swaps", frequency: "regular" },
  { name: "Ben Castellano", email: "ben.castellano@example.com", phone: "+60 18-336 6641", birthday: "1988-09-30", allergies: [], frequency: "regular" },
  { name: "Nadia Haddad", email: "nadia.haddad@example.com", phone: "+60 19-350 8123", birthday: "1992-01-08", allergies: ["gluten"], preferences: "Gluten-free pasta every time", frequency: "regular" },
  { name: "Oliver Grant", email: "oliver.grant@example.com", phone: "+60 11-374 9910", birthday: "1983-06-21", allergies: [], preferences: "Big group bookings", frequency: "regular" },
  { name: "Sara Mendes", email: "sara.mendes@example.com", phone: "+60 12-388 2277", birthday: "1996-03-14", allergies: [], frequency: "occasional" },
  { name: "Jonas Weber", email: "jonas.weber@example.com", phone: "+60 13-402 5566", birthday: "1990-12-02", allergies: ["egg"], frequency: "occasional" },
  { name: "Aisha Bello", email: "aisha.bello@example.com", phone: "+60 14-419 3348", birthday: "1993-08-25", allergies: [], preferences: "Delivery only, leave at door", frequency: "occasional" },
  { name: "Tomás Rivera", email: "tomas.rivera@example.com", phone: "+60 16-433 7712", birthday: "1985-10-09", allergies: [], frequency: "occasional" },
  { name: "Grace Whitmore", email: "grace.whitmore@example.com", phone: "+60 17-447 1129", birthday: "1999-04-18", allergies: ["nuts", "dairy"], frequency: "occasional" },
  { name: "Hiroshi Tanaka", email: "hiroshi.tanaka@example.com", phone: "+60 18-458 9902", birthday: "1981-07-07", allergies: [], preferences: "Counter seat, espresso to finish", frequency: "occasional" },
  { name: "Lena Kowalski", email: "lena.kowalski@example.com", phone: "+60 19-466 4471", birthday: "1995-08-13", allergies: [], frequency: "once" },
  { name: "Ethan Brooks", email: "ethan.brooks@example.com", phone: "+60 11-472 8890", birthday: "1998-02-26", allergies: [], frequency: "once" },
  { name: "Farida Nasser", email: "farida.nasser@example.com", phone: "+60 12-488 3312", birthday: "1987-11-05", allergies: ["fish"], frequency: "once" },
  { name: "Callum Reid", email: "callum.reid@example.com", phone: "+60 13-495 6620", birthday: "1984-09-16", allergies: [], preferences: "Used to come weekly", frequency: "lapsed" },
  { name: "Isabella Ferrari", email: "isabella.ferrari@example.com", phone: "+60 14-502 7734", birthday: "1989-05-29", allergies: [], preferences: "Regular before she moved districts", frequency: "lapsed" },
  { name: "Yusuf Demir", email: "yusuf.demir@example.com", phone: "+60 16-517 2245", birthday: "1992-08-11", allergies: ["sulphites"], frequency: "lapsed" },
];
...
export const REVIEW_COMMENTS = [
  ...
  { rating: 5, comment: "Booked for my birthday and they applied the RM30 reward automatically." },
